...
class ReactEditor : public AudioProcessorEditor, public AudioProcessorParameter::Listener, public Timer {
   public:
    ReactEditor(AudioProcessor& proc)
   ...
   private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ReactEditor)
};
